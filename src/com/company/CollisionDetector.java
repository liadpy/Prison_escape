...
public class CollisionDetector{
    ...
    public void checktile(Entity entity, Semaphore sem) {
        ...
        int tile1, tile2;
        if (entitytoprow <= 80 && entitybottomrow <= 80 && entityleftcol <= 132 && entityrightcol <= 132) {  //making sure im not out of bounds (index)
    ...
    public int checkObj(Entity entity,Semaphore sem){
        int indx=-1;
    ...
    public int checkentity(Entity entity,Entity[] target,Semaphore sem){//# *** "entity"=player
        int indx=-1;
